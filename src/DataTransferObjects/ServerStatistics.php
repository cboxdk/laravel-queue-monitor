...
/**
 * Aggregated job statistics for a single server.
 *
 * @implements Arrayable<string, mixed>
 * @implements ArrayAccess<string, mixed>
 */
final readonly class ServerStatistics implements Arrayable, ArrayAccess, JsonSerializable
{
    ...
    {
        return new self(
            serverName: self::stringFrom($data, 'server_name'),
